    ...
    render() {
        ...
        return (
            <div>
                ...
                <Button type="danger" onClick={deleteUser.bind(this, this.state.user.id)}>删除</Button>
                <Drawer
                    title="用户信息"
                    width={720}
...
class Index extends Component {
    ...
    getUsers = (userId) => {
        //console.log(value);
        axios.get('http://localhost:3005/user/list', {
            params: {
                userId: userId,
            }
        }).then((data) => {
    ...
    render() {
        ...
        return (
            <div> 
                <div className="search"><Search placeholder="请输入用户ID" onSearch={value => this.getUsers(value)} enterButton /></div>
